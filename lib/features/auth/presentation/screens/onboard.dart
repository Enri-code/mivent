...
class _OnboardScreenState extends State<OnboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double imageYOffset = 122;
    var size = MediaQuery.of(context).size;
    var lowerSectionOffset = size.width * 0.98148 - 32;
    return SafeScaffold(
      child: Stack(
        children: [
          Hero(
              ...
              return Material(
                child: Stack(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          top: lowerSectionOffset + imageYOffset),
            ...
            child: Stack(
              children: [
                Padding(
                  padding: EdgeInsets.only(top: imageYOffset),
                  child: ImageSection(isHost: isHost),
                ),
                const _TitleSection(),
                Padding(
                  padding:
                      EdgeInsets.only(top: lowerSectionOffset + imageYOffset),
                  child: _LowerSection(
                    isHost: isHost,
                    minHeight: size.height -
                        MediaQuery.of(context).viewPadding.vertical -
...
class _TitleSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.only(bottomLeft: Radius.elliptical(48, 24)),
